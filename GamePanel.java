...
public class GamePanel extends JPanel implements ActionListener{
	...
	static final int GAME_UNIT=(SCREEN_WIDTH*SCREEN_HEIGH)/UNIT_SIZE;
	 int DELAY=90;
...
//	public MenuHander menu = new MenuHander(this);
	GamePanel()
	{
		random= new Random();
	...
	public void newPoint() {
		...
		PointY =random.nextInt((int)(SCREEN_HEIGH/UNIT_SIZE))*UNIT_SIZE;
	}
...
//			g.drawLine(0, i*UNIT_SIZE,SCREEN_HEIGH , i*UNIT_SIZE);
//	
//		}
...
//				g.setColor(new Color(random.nextInt(255),random.nextInt(255),random.nextInt(255)));
	...
	public void gameOver(Graphics g)
	{
		...
		FontMetrics metrics=getFontMetrics(g.getFont());
		g.drawString("Game Over",(SCREEN_WIDTH-metrics.stringWidth("GameOver"))/2,SCREEN_HEIGH/2);
